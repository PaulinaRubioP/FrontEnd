...
//aumentar y disminuir contador de amistades
let numContainer = document.getElementById('num');
let value = 0;
let btnInc = document.querySelector('.icon1');
let btnDec = document.querySelector('.icon2');
let btnInc2 = document.querySelector('.icon3');
let btnDec2 = document.querySelector('.icon4');
...
btnInc2.addEventListener("click", () => {value++;numContainer.textContent = value});
btnDec2.addEventListener("click", () => {value--;numContainer.textContent = value});
